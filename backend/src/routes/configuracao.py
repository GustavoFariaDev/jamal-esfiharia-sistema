...
@configuracao_bp.route('/status', methods=['GET'])
...
@configuracao_bp.route('/status/admin', methods=['GET'])
@jwt_required()
...
@configuracao_bp.route('/status/toggle', methods=['POST'])
@jwt_required()
def toggle_status():
...
@configuracao_bp.route('/status/pausar-temporario', methods=['POST'])
@jwt_required()
...
@configuracao_bp.route('/status/cancelar-pausa', methods=['POST'])
@jwt_required()
def cancelar_pausa():
...
@configuracao_bp.route('/status/update', methods=['PUT'])
@jwt_required()
def update_status():
...
@configuracao_bp.route('/config', methods=['GET'])
@jwt_required()
...
@configuracao_bp.route('/config/<chave>', methods=['GET'])
...
@configuracao_bp.route('/config', methods=['POST'])
@jwt_required()
...
@configuracao_bp.route('/config/<int:config_id>', methods=['DELETE'])
@jwt_required()
